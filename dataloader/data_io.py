...
def scale_crop_toy(input_size, scale_size=None, normalize=__gray_stats):
    t_list = [
...
def get_transform_toy(name='imagenet', input_size=None,
                  scale_size=None, normalize=None, augment=True):
    normalize = __gray_stats
    input_size = 256
    if augment:
        return inception_color_preproccess(input_size, normalize=normalize)
    else:
        return scale_crop_toy(input_size=input_size,
                              scale_size=scale_size, normalize=normalize)
